...
void loop() {
 suhu_z = dht.readTemperature();
  ...
  // // Kirim data ke Blynk
  // Blynk.virtualWrite(V0, roundkelembaban); // Kirim kelembaban ke virtual pin V0
  // Blynk.virtualWrite(V1, roundsuhu); // Kirim suhu ke virtual pin V1
  // Blynk.virtualWrite(V2, durasi_z); // Kirim kecepatan kipas ke virtual pin V2
